...
export const ARCHETYPES: Archetype[] = [
  {
    ...
    cardImagePath: '/archetypes/techno-cosmopolitan.png',
    cardColor: '#0066FF',
    exemplars: [
  ...
  },
  {
    ...
    cardImagePath: '/archetypes/civic-progressive.png',
    cardColor: '#10B981',
    exemplars: [
  ...
  },
  {
    ...
    cardImagePath: '/archetypes/market-rebel.png',
    cardColor: '#FF2A54',
    exemplars: [
  ...
  },
  {
    ...
    cardImagePath: '/archetypes/solidarity-sceptic.png',
    cardColor: '#E11D48',
    exemplars: [
  ...
  },
  {
    ...
    cardImagePath: '/archetypes/protectionist-traditionalist.png',
    cardColor: '#D97706',
    exemplars: [
  ...
  },
  {
    ...
    cardImagePath: '/archetypes/local-builder.png',
    cardColor: '#059669',
    exemplars: [
  ...
  },
  {
    ...
    cardImagePath: '/archetypes/open-society-reformer.png',
    cardColor: '#0284C7',
    exemplars: [
  ...
  },
  {
    ...
    cardImagePath: '/archetypes/cautious-egalitarian.png',
    cardColor: '#65A30D',
    exemplars: [
  ...
  },
  {
    ...
    cardImagePath: '/archetypes/sovereign-entrepreneur.png',
    cardColor: '#8B5CF6',
    exemplars: [
  ...
  },
  {
    ...
    cardImagePath: '/archetypes/order-liberal.png',
    cardColor: '#2563EB',
    exemplars: [
  ...
  },
  {
    ...
    cardImagePath: '/archetypes/techno-populist.png',
    cardColor: '#06B6D4',
    exemplars: [
  ...
  },
  {
    ...
    cardImagePath: '/archetypes/independent-humanist.png',
    cardColor: '#DB2777',
    exemplars: [
...
export const UNFINISHED_PORTRAIT: Archetype = {
  ...
  cardImagePath: '/archetypes/card-back.png',
  cardColor: '#64748B',
  exemplars: [
...
export function assignArchetype(scores: Scores, coverage: Coverage): ArchetypeResult {
  ...
  if (best.distance > 0.18) {
    return {
      archetype: {
        ...MIXED_SIGNAL,
        cardImagePath: best.archetype.cardImagePath || '/archetypes/independent-humanist.png',
